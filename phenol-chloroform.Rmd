...
## Reagents
- Phenol:chloroform:isoamyl alcohol (25:24:1 v/v, pH 8.0)^[Use of acidic phenol
will cause DNA to fractionate into the organic phase, complicating subsequent
purification.]
- Chloroform:isoamyl alcohol (24:1 v/v)
- 3 M sodium acetate, pH 5.2 *or* 10 M ammonium acetate
...
- **Ammonium acetate (10 M)**. Dissolve 77 g of ammonium acetate in 70 mL of 
water at room temperature. Adjust final volume to 100 mL.
...
2. Add 1$\times$ volume of phenol:chloroform:isoamyl alcohol.
Vortex vigorously. Centrifuge at 16 000 g for 2 min to seprate the phases.
Transfer the upper, aqueous phase to a new tube.
Avoid collecting the interphase.

3. Repeat phenol-chloroform purification until interphase no longer appears
(0--2 additional rounds).

4. Add 1$\times$ volume of chloroform:isoamyl alcohol. Repeat as
above in order to remove residual phenol.

5. Repeat the chloroform purification to ensure no phenol remains.
...
- **Alternative 1**. To prevent co-precipitation of free nucleotides, preciptate
    DNA by adding 0.25 volume of 10 M ammonium acetate and 2.5 volumes of
