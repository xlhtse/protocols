...
mismatch [@zhou09]. A plasmid with a single base-pair mismatch (known as a 
**heteroduplex plasmid**) will be prepared and transfected into cells, 
followed by flow cytometry to quantify the proportion of mismatch repair 
competent cells.
...
Precipitate with *ammonium* acetate and ethanol: Add 0.25 volume of 10 M
